...
$pdf->Image('img/logo_cmg.jpg',90,10,30,20);

$pdf->SetXY(6,33);
$pdf->SetFont('arial','b',10);       // Define a fonte
$pdf->MultiCell(200,5,"CÂMARA MUNICIPAL DE GUARULHOS",0,'C',false,1);

$pdf->SetXY(6,42);
$pdf->SetFont('arial','b',10);       // Define a fonte
$pdf->MultiCell(200,5,"COMPROVANTE DE PROTOCOLO",0,'C',false,1);

$pdf->SetXY(6,49);
$pdf->SetFont('arial','',8);       // Define a fonte
$pdf->MultiCell(200,5,$setor['Setor']['sigla'].'-'.$setor['Setor']['descricao'],0,'C',false,1);
...
$pdf->SetXY(10,140);
$pdf->MultiCell(75,5,"Autor:",0,'R',false,3);
...
$pdf->SetXY(60,260);
$pdf->SetFont('arial','b',10);       // Define a fonte
$pdf->MultiCell(90,5, '____________________________________________',0,'L',false,15);
$pdf->SetXY(60,265);
$pdf->SetFont('arial','',7);       // Define a fonte
$pdf->MultiCell(90,5, $servidor,0,'C',false,15);
