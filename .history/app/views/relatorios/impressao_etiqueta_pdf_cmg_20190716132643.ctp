...
$pdf->MultiCell(69,5,"Processo nº" . $processo['Processo']['numero_processo'] . '/' . $processo['Processo']['numero_ano'],0,'J',false);
$pdf->SetXY(5+68*$coluna,17+70*$linha); 
$pdf->MultiCell(69,5,"Interessado: " . $processo['Interessado']['nome'],0,'J',false);
$pdf->SetXY(5+68*$coluna,27+70*$linha); 

$pdf->MultiCell(69,5,"Assunto: " . $processo['Processo']['assunto'],0,'J',false,5);
