...
$pdf->SetXY(10,140);
$pdf->MultiCell(75,5,"Tipo de Projeto:",0,'R',false,1);

$pdf->SetXY(10,155);
$pdf->MultiCell(75,5,"Tipo de Documento:",0,'R',false,1);

$pdf->SetXY(10,170);
$pdf->MultiCell(75,5,"Tipo de Assunto:",0,'R',false,1);
...
$pdf->SetXY(10,215);
$pdf->MultiCell(75,5, $processo['Processo']['numero_processo'].'-'.$processo['Processo']['ano_processo'],0,'L',false,1);
