...
// Definições de tamanho das etiquetas
...
$dados[3] = substr("Assunto: " . $processo['Processo']['titulo_assunto'], 0, 37);
 ...
 * Margem esquerda = {
    ...
    Se for a etiqueta direita {
        margem superior da etiqueta + largura da etiqueta + espaço horizontal entre etiquetas
    }
 }
 *
 * Todas as magens recebem 10mm a mais para segurança e distanciar da borda
 * 
