...
$dados[3] = substr("Assunto: " . $processo['Processo']['assunto'], 0, 38);
$dados[4] = substr("Assunto: " . $processo['Processo']['assunto'], 37, 50);
$dados[5] = substr("Assunto: " . $processo['Processo']['assunto'], 50, 60);
