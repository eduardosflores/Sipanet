...
<!--                         <td class="tdConteudoGrid">
						...
						<td class="tdConteudoGrid">
							<?php echo $html->link($processo['Processo']['titulo_assunto'], 'consultar/'.$processo['Processo']['id'])?>
                        </td>                        
						<td class="tdConteudoGrid">
							<?php echo $html->link($processo['Processo']['assunto'], 'consultar/'.$processo['Processo']['id'])?>
						</td>                                              
						<td class="tdConteudoGrid">
