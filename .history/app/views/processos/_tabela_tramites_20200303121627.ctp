...
?>
    <tr class="trDisplay">
        ...
        <td class="tdConteudoGrid">
            ...
            <a href="#" onclick="window.open('<?php echo $html->link('consultar_tramite/'.$tramite['Tramite']['id'])?>', 'buscarInteressados', 'location=0,status=0,scrollbars=1,width=650, height=400')">Exibir Despacho</a>
