<div class="div_principal">
        ...
        <table cellpadding="2" cellspacing="2" border="0" class="tbConteudoExibirDetalhes">
            <tr>
                ...
                <td class="tdConteudoExibirDetalhes">
                    <?php echo $processo['Processo']['numero_processo'] ?>/<?php echo $processo['Processo']['numero_ano'] ?>
                </td>
            </tr>
            <tr>
                <td class="tdTituloExibirDetalhes">
            ...
            ?>            
                ...
                ?>
                    <tr>
                        <td colspan="2">
                            <?php echo $arquivoFTP['Arquivo']['nome_arquivo'] ?> - <a href="<?php echo "arquivoftp/".$arquivoFTP['Arquivo']['id'] ?>" >Download</a>
                        </td>
                    </tr>
                <?php
                }
    ...
    <fieldset class="fieldset">
        ...
        <form action="<?php echo $form->url("/processos/consultar/"); ?>" method="post" name="addform">
            <div class="impressao">
                <input type="button" value="Imprimir Capa"/>
            </div>
