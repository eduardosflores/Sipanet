...
class ProcessosController extends AppController {
    ...
    public function index() {
        ...
        $this->set('processos', $this->paginate('Processo',null,array('order'=>(array('Processo.numero_ano' => 'desc', 'Processo.numero_processo' => 'desc')))));
    }
    ...
    public function tramitacao() {
        ...
        $this->set('fieldSetTitle', 'Lista de Tr�mites do Processo');
