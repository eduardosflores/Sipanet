...
class RelatoriosController extends AppController {
    ...
    /**
     * Relat�rio de processos com busca completa
     * **/
    function processos() {
    //Consulta geral dos processos
        $this->set('fieldSetTitle', 'Relat�rio - Processos');
        ...
        // Verifica se a consulta acabou de ser realizada
            ...
            // Verifica se o �rg�o foi passado. Se foi, resgata a lista de setores para exibi��o
            if(array_key_exists('orgao_id', $this->data['Busca']) && ($this->data['Busca']['orgao_id'] != "")) {
            // Lista de sele��o de setores - j� que o �rg�o foi selecionado, podemos retornar o setor para exibi��o
                $this->set('setores', $this->Setor->findByOrgao($this->data['Busca']['orgao_id']));
            }

            // Resgata os crit�rios para busca
            $criterios = $this->Processo->resgatarCriteriosBusca($this->data['Busca']);

            if($criterios) {
            // Define os crit�rios da p�gina��o
                ...
                $this->setMessage('erro', 'Nenhum crit�rio de busca informado.');
            }
        }
    }

    /**
     * Relat�rio de processos lentos.
     * S�o resgatados os processos n�o recebidos e encaminhados determinada quantidade de dias atr�s
     * **/
    function processos_lentos() {
        $this->set('fieldSetTitle', 'Relat�rio - Processos Lentos');
    ...
    /**
     * Relatorio para exibi��o de dos processos que est�o atrasados, de acordo
     * com a configura��o existem em dias na mesa.
     */

    function processos_atrasados() {

        $this->set('fieldSetTitle', 'Relat�rio - Processos Atrasados');
    ...
    /**
     * Relat�rio com busca pelos tr�mites
     * **/
    function tramites() {
    //Consulta geral dos processos
        $this->set('fieldSetTitle', 'Relat�rio - Tr�mites');
    ...
    /**
     * Relat�rio com busca pelos tr�mites n�o recebidos
     * **/
    ...
    //Consulta geral dos processos
        ...
        if(isset($this->data)) {
            ...
            // Informa o setor de origem como o setor onde o usu�rio est� logado
            $this->data['Busca']['setor_origem_id'] = $this->Session->read('Setor.id');

            // Informa que deve retornar apenas os tr�mites n�o recebidos
    ...
    //Consulta geral dos processos
        $this->set('fieldSetTitle', 'Relat�rio - Tramita��o entre setores');
    ...
    /**
     * Impress�o do boletim de informa��o. Primeiro passo, busca pelos tr�mites.
     * O BI � um documento contendo processos encaminhados de um setor para o outro e as assinaturas de envio e recebimento.
     * **/
    function boletim_de_informacao() {
        $this->set('fieldSetTitle', 'Imprimir Boletim de Informa��o');

        // Listas necess�rias para popular campos de sele��o
        $this->set('orgaos', $this->Orgao->listar());
        // Setores do �rg�o onde o usu�rio est� logado
        ...
        // Formata as datas
            ...
            // Formata a URL que ser� chamada para impress�o
    ...
    /**
     *
     * Impress�o do boletim de informa��o de processos distribuidos. Primeiro passo, buscar processos distribuidos para o servidor selecionado.
     * O BI de distribuicao � um documento contendo processos encaminhados para um servidor e as assinaturas de envio e recebimento.
     * **/
    function boletim_de_informacao_de_distribuicao() {
        $this->set('fieldSetTitle', 'Imprimir Boletim de Informa��o de Distribui��o');
    ...
    /**
     * Impress�o do boletim de informa��o. Segundo passo, gera��o do pdf.
     * **/
    ...
    function distribuicao() {
        ...
        $this->set('fieldSetTitle', 'Imprimir Relat�rio de Distribui��o');
