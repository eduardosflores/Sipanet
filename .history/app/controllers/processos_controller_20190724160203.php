    ...
    public function consultar_completo() {
        ...
        // Se foi passado o id, busca pelo id. Sen?o, busca pelo n?mero
            ...
            if ($this->data['Processo']['numero_orgao']!=""){
                ...
                $condicoes = "busca Processo.numero_orgao = ('".data['Processo']['numero_orgao']."')";
            }
            ...
            if ($this->data['Processo']['numero_processo']!=""){
                ...
                $condicoes = "busca Processo.numero_processo = ('".data['Processo']['numero_processo']."')";
            }
            ...
            if ($this->data['Processo']['numero_ano']!=""){
                ...
                $condicoes = "busca Processo.numero_ano = ('".data['Processo']['numero_ano']."')";
            }            
                ...
                foreach($arquivosDiretorioTemporario as $arquivoTemp) {
                    ...
                    if($chaveArquivo == $chaveArquivoFTP){
                        if($ftp->moveArquivo($arquivoTemp,'/'.$id.'/'.$nomeArquivo)){
                            ...
                            if($this->Arquivo->save($arquivo)==false){
                    ...
                    } else if($ftp->deletaArquivo($arquivoTemp)==false){
                        $db->rollback;
                        // Se ocorrer erro ao savar, exibe mensagem de erro
                        // passando os arrays com os erros de valida??o
                        $this->setMessage("erro", "Ocorreu um erro ao tramitar o processo.");
...
public function recebimento_lote() {
    ...
    public function arquivoftp($arquivo_id = null) {
        $arquivo = $this->Arquivo->findByID($arquivo_id);
...
//        $this->set("arquivo",$arquivoBinario);
    ...
    function download ($arquivo_id = null) {
        $this->view = 'Media';
        ...
        $arquivoBinario = $ftp->recuperarArquivoComNome('/'.$arquivo['Arquivo']['id_processos'].'/'.$arquivo['Arquivo']['nome_arquivo'],$arquivo['Arquivo']['nome_arquivo']);
        ...
        $params = array(
              ...
              'path' => '/processos/arquivoftp/'.$arquivo_id
       );
       $this->set($params);
    }
