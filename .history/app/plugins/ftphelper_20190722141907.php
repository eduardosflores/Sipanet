<?php
    ...
    class FTPHelper{
        ...
        function enviarArquivoFTP($caminho,$arquivo){
            $con_id = $this->getCon();
            if($con_id){                
                return ftp_nb_fput( $con_id, $caminho, $arquivo, FTP_BINARY );
            } else {
                return false;         
            }
        }
        ...
        function recuperarArquivo($caminho){
            ...
            if($con_id){
                return $this->ftp_get($con_id, '/tmp/arquivo.pdf', $caminho, FTP_BINARY );
            } else {
                return false;         
            }            
        }
        ...
        function recuperarArquivoComNome($caminho,$nomeArquivo){
            $con_id = $this->getCon();
