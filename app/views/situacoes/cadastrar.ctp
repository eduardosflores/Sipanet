<div class="div_principal">
    <form action="<?php echo $html->url('/situacoes/cadastrar')?>" method="post" name="addform">
            ...
            <table cellpadding="2" cellspacing="0" border="0" class="tbFrm">
                <tr>
                    <td colspan="2" align="left">
                        <br /><label class="lbInfoPagFrm">Preencha os dados do formulário para cadastrar um novo Situacao:</label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="left">
                ...
                <tr>
                   ...
                   <td class="tbFieldFrm">
                        <?php echo $form->input('Situacao.nome', array('label'=>false,'class'=>'textField textFieldWidth240'))?>
                   </td>
                </tr>
                <tr>
