<div class="div_principal">
	<form action="<?php echo $html->url('/processos/arquivar/')?>" method="post" name="addform">
            ...
            <table cellpadding="2" cellspacing="0" border="0" class="tbFrm">
            	<tr>
                    <td class="lbInfoPagFrm" colspan="2" align="left">
                        <b>Confirme o arquivamento do Processo:</b>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                   ...
                   <td class="tbFieldFrm">
                        <?php echo $form->textarea('Arquivamento.motivo', array('label'=>false,'class'=>'textArea textFieldWidth240', 'rows' => '5'))?>
                   </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="tbFieldFrm">
                        ...
                        <input type="button" id="btnCancelar" name="btnCancelar" onclick="javascript:window.location='<?php echo $this->webroot . 'processos/arquivamento/' ?>'" value="Cancelar" />
                    </td>
                </tr>
            </table>
        </fieldset>
