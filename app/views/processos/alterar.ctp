...
<div class="div_principal">
    <form action="<?php echo $html->url('/processos/alterar/' . $processo['Processo']['id'])?>" method="post" name="addform">
	        ...
	        <tr id="tipo_de_processo">
                ...
                <tr>
                    ...
                    <td class="tbFieldFrm">
                        ...
                        <input type="button" id="btnCancelar" name="btnCancelar" onclick="javascript:window.location='<?php echo $html->url('/processos/alteracao') ?>'" value="Cancelar" />
                    </td>
                </tr>
            </table>
        </fieldset>
