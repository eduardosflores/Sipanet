<div class="div_principal">
    <form action="<?php echo $html->url('/grupos_usuario/cadastrar')?>" method="post" name="addform">
            ...
            <table cellpadding="2" cellspacing="0" border="0" class="tbFrm">
                <tr>
                    <td colspan="2" align="left">
                        <br /><label class="lbInfoPagFrm">Preencha os dados do formulário para cadastrar um novo Grupo de Usuario:</label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="left">
