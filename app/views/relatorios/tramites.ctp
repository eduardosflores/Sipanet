<div class="div_principal">
    <form action="<?php echo $form->url("/relatorios/tramites"); ?>" method="post" name="addform">
        <fieldset class="fieldset">
            ...
            <table cellpadding="2" cellspacing="0" border="0" class="tbFrm">
                ...
                <tr>
                    ...
                    <td class="tbFieldFrm">
                        <select name="data[Busca][filtro]" id="BuscaFiltro"  class="comboBox textFieldWidth240">
                            <option value="origem">Processos tramitados pelo setor</option>
                            <option value="recebimento">Processos recebidos pelo setor</option>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="tbFieldFrm">
                        <select name="data[Busca][setor_id]" id="BuscaSetorId" class="comboBox textFieldWidth240">
                            ...
                            <?php if(count($setores) > 0) { echo "<option value='*'>Todos</option>"; } ?>
                            <?php
