<div class="div_principal">
    <fieldset class="fieldset">
        ...
        <table cellpadding="2" cellspacing="0" border="0" class="tbFrm">
            <form action="<?php echo $form->url("/relatorios/distribuicao"); ?>" method="post" name="addform">
                <tr>
...
if(isset($divisoes) && is_array($divisoes))
{
    ...
    {
        ?>
            <form action="<?php echo $form->url("/relatorios/distribuicao_pdf/" . $url); ?>" method="post" name="addform" target="_blank">
