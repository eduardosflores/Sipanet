<div class="div_principal">
    <form action="<?php echo $html->url('/interessados/alterar/'.$this->data['Interessado']['id'])?>" method="post" name="editform">
            ...
            <table cellpadding="2" cellspacing="0" border="0" class="tbFrm">
                <tr>
                    <td colspan="2" align="left">
                        <br /><label class="lbInfoPagFrm">Preencha os dados do formulário para alterar os dados do Interessado:</label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="left">
		...
		<?php echo $form->hidden('Interessado.id'); ?>
    </form>
</div>
<br />