<?php
// Se o interessado já estiver cadastrado, envia os dados dele para o cadastro de processo.
if( isset($interessado_cadastrado) && ($interessado_cadastrado === true))
{
?>
    <script type="text/javascript" language="JavaScript">
        opener.receberInteressado('<?php echo $id; ?>', '<?php echo $nome; ?>');
        window.close();
    </script>
<?php
}
// Senão, exibe a tela de cadastro
else
{
?>
    <div class="div_principal">
        <form action="<?php echo $html->url('/interessados/cadastrar_popup')?>" method="post" name="addform">
                ...
                <table cellpadding="2" cellspacing="0" border="0" class="tbFrm">
                    ...
                    <tr>
                        ...
                        <td class="tbFieldFrm">
                            ...
                            <input type="button" id="btnCancelar" name="btnCancelar" onclick="javascript:window.location='<?php echo $this->webroot . 'interessados/busca_popup' ?>'" value="Cancelar" />
                        </td>
                    </tr>
                </table>
            </fieldset>
