...
<form action="<?php echo $html->url('/modulos/cadastrar/')?>" method="post" name="addform">
            ...
            <table cellpadding="2" cellspacing="0" class="tbFrm">
                <tr>
                    <td colspan="2" align="left">
                        <br /><label class="lbInfoPagFrm">Preencha os dados do formulário para cadastrar um Modulo:</label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="left">
